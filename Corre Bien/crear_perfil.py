...
def agregar_perfil():
    ...
    while True:
        ...
        if event=='Guardar':
            ...
            cargar_csv_json.cargar_json(usuario_nuevo,ok,datos)#llama al modulo para cargar json
            
            cargar_csv_json.cargar_csv(usuario_nuevo["Alias"],"Creo perfil")#llama al modulo para cargar csv
