...
def window_seleccionar_template(alias):
    """
    Mustra la ventana de seleccionar_template. En esta ventana se muestra un menú para elegir el archivo a hacer meme.
    """
    ...
    while True:
        ...
        if event == "-ARCHIVOS-":
            ...
            try:
                ...
                for archivo in templates:
                    if (archivo['name'] == values["-ARCHIVOS-"][0]):
                        datos = archivo
                #Mostramos en pantalla el meme seleccionado.
