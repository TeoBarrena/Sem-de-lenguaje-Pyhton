...
def agregar_perfil():
    ...
    if os.path.getsize('Archivos/perfiles.json') > 0:
        try:
            with open('Archivos/perfiles.json', 'r') as archivo:
                datos = json.load(archivo)
                ok = True
        except:
            print("Error con el archivo 'perfiles.json'")
    else:
        datos = []
        ok = False
    ...
    while True:
        ...
        if event=='Guardar':
            ...
            foto = nombre_foto.name_foto(ruta_imagen)
